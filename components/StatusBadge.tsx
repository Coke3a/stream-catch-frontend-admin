...
const STATUS_STYLES: Record<string, string> = {
  ...
  done: 'border-emerald-200 bg-emerald-100/70 text-emerald-800',
  sent: 'border-emerald-200 bg-emerald-100/70 text-emerald-800',
  failed: 'border-rose-200 bg-rose-100/70 text-rose-700',
  dead: 'border-rose-200 bg-rose-100/70 text-rose-700',
  ...
  queued: 'border-amber-200 bg-amber-100/70 text-amber-800',
  requires_action: 'border-amber-200 bg-amber-100/70 text-amber-800',
  ...
  void: 'border-slate-200 bg-slate-100/70 text-slate-700',
  ...
  expired: 'border-rose-200 bg-rose-100/70 text-rose-700',
  ...
  running: 'border-sky-200 bg-sky-100/70 text-sky-700',
  processing: 'border-sky-200 bg-sky-100/70 text-sky-700',
  resolved: 'border-emerald-200 bg-emerald-100/70 text-emerald-800',
  closed: 'border-slate-200 bg-slate-100/70 text-slate-700',
  none: 'border-slate-200 bg-slate-100/70 text-slate-700',
};
